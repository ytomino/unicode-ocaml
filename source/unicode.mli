...
val utf16_encode: ?illegal_sequence:exn -> ('a -> 'b -> utf16_char -> 'a) ->
	'a -> 'b -> Uchar.t -> 'a
...
val utf32_encode: ?illegal_sequence:exn -> ('a -> 'b -> utf32_char -> 'a) ->
	'a -> 'b -> Uchar.t -> 'a
...
module UTF8: sig
	...
	val decode: ?illegal_sequence:exn -> ('a -> 'b -> utf8_char) ->
		('a -> 'b -> 'b) -> ('a -> 'b -> bool) -> 'a -> 'b -> 'c -> 'd -> 'e ->
		('a -> 'b -> 'c -> 'd -> 'e -> Uchar.t -> 'f) -> 'f
...
module UTF16: sig
	...
	val sequence: ?illegal_sequence:exn -> elm -> int
	val max_sequence: int
	val decode: ?illegal_sequence:exn -> ('a -> 'b -> utf16_char) ->
		('a -> 'b -> 'b) -> ('a -> 'b -> bool) -> 'a -> 'b -> 'c -> 'd -> 'e ->
		('a -> 'b -> 'c -> 'd -> 'e -> Uchar.t -> 'f) -> 'f
	val get_code: ?illegal_sequence:exn -> t -> int ref -> Uchar.t
	val lead: t -> int -> int
...
module UTF32: sig
	...
	val sequence: ?illegal_sequence:exn -> elm -> int
	val max_sequence: int
	val decode: ?illegal_sequence:exn -> ('a -> 'b -> utf32_char) ->
		('a -> 'b -> 'b) -> ('a -> 'b -> bool) -> 'a -> 'b -> 'c -> 'd -> 'e ->
		('a -> 'b -> 'c -> 'd -> 'e -> Uchar.t -> 'f) -> 'f
	val get_code: ?illegal_sequence:exn -> t -> int ref -> Uchar.t
	val lead: t -> int -> int
